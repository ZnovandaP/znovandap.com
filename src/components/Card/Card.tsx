...
export default function Card({ children, className = '' }: CardProps) {
  return (
    <div
      className={cn(
        'bg-stone-50 dark:bg-stone-900 shadow-lg shadow-stone-400/60 dark:shadow-stone-700/70 ring-1 ring-stone-500/60 rounded-lg hover:scale-[1.025] active:scale-100 transition-all duration-300',
...
function CardMedia({ src, alt }: { src: string, alt: string }) {
  return (
    <div className="w-full h-[200px] lg:h-[175px]">
      <Image
        src={src}
        alt={alt}
        width={600}
