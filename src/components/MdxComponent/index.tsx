  ...
  return (
    <Markdown
      ...
      components={{
        ...
        ul: (props) => <ul className="pl-10 space-y-3 list-disc pb-3 mt-3 font-medium" {...props} />,
        ol: (props) => <ol className="pl-10 space-y-3 list-decimal pb-3 mt-3 font-medium" {...props} />,
        blockquote: (props) => (
          <blockquote
